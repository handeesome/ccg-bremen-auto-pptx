...
var getTotalLines = function (bookIndex, chapterIndex) {
  ...
  return chapter_lines.length <= mainChapterIndex
    ? -1
    : chapter_lines[mainChapterIndex] - chapter_lines[mainChapterIndex - 1];
};
...
var searchLine = function (bookIndex, chapter, line) {
  ...
  var bookChapterStartIndex = book_chapters[bookIndex];
  var bookChapterEndIndex = book_chapters[bookIndex + 1];
  if (chapter < 1 || chapter > bookChapterEndIndex - bookChapterStartIndex)
    return -2;

  var chapterIndex = bookChapterStartIndex + chapter - 1;
  var totalChapterLines =
    chapter_lines[chapterIndex + 1] - chapter_lines[chapterIndex];
