...
var validLine = function (mainLine, bookName, chapterIndex, line) {
  if (mainLine == -1) Searcher.onError("找不到書名", bookName);
    ...
    Searcher.onError("句子不存在", bookName + " " + chapterIndex + ":" + line);
  else {
    return true;
  }
  return false;
...
var find = function (bookName, iChapterIndex1, iLine1, iChapterIndex2, iLine2) {
  ...
  line2 = iLine2 === -1 ? getTotalLines(bookIndex, chapterIndex2) : iLine2;
